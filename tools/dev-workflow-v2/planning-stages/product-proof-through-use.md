# product-proof-through-use

Create and approve:

```text
docs/project/PRD/<planning-id>/product-proof-through-use.md
```
...
You will produce the document `docs/project/PRD/<planning-id>/product-proof-through-use.md` with this exact top level structure:
...
Reminder: don't just do the bare minimum here. The dogfooding projects are there to test our projects and can be evolved or modified as needed to test as many uses cases as possible with different settings and configurations, mirroring our users who will have many varified worfklows.
...
Now that you've produced the document discuss it with the user. Where might you do things differently? ARe there areas that might be worth exploring in more detail? How about iterating on the solution together or exploring variations of it?. The conversation is important, don't skip it.
