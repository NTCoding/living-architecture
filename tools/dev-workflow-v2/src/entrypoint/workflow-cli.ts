...
import { buildRealDeps } from '../infra/domain/composition-root'
import { EXIT_ERROR } from '../infra/domain/hook-io'
import { getErrorLogPath } from '../infra/domain/environment'
