...
describe('resolveInterface', () => {
  it('resolves to concrete type when interface has exactly one implementation', () => {
    ...
    const result = resolveInterface('PaymentGateway', sharedProject, [interfaceFile, implFile], {
      strict: false,
    })
  ...
  it('resolves to concrete type when abstract class has exactly one extension', () => {
    ...
    const result = resolveInterface('BaseRepository', sharedProject, [abstractFile, implFile], {
      strict: false,
    })
  ...
  it('returns unresolved with reason when zero implementations in lenient mode', () => {
    ...
    const result = resolveInterface('UnusedInterface', sharedProject, [interfaceFile], {
      strict: false,
    })
  ...
  it('returns unresolved with reason when multiple implementations in lenient mode', () => {
    ...
    const result = resolveInterface('Notifier', sharedProject, [interfaceFile, impl1, impl2], {
      strict: false,
    })
  ...
  it('resolves to single implementation when only one is within provided source files', () => {
    ...
    const result = resolveInterface('Cache', sharedProject, [interfaceFile, inScopeImpl], {
      strict: false,
    })
  ...
  it('excludes node_modules file paths from search', () => {
    ...
    const result = resolveInterface('Service', sharedProject, [interfaceFile, nodeModulesFile], {
      strict: false,
    })
