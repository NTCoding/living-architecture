...
type ResolveTargetInput = Readonly<{
  project: Project
...
export class ResolvedCallTarget {
  ...
  static fromDetectedCall(call: DetectedCall, input: ResolveTargetInput): ResolvedCallTarget {
...
function resolveAbstractType(typeName: string, input: ResolveTargetInput): TypeResolution {
