import { CustomTypeAlreadyDefinedError } from '@living-architecture/riviere-builder/domain/construction/construction-errors'
import { CustomPropertyType } from '@living-architecture/riviere-schema/custom-property-type'
