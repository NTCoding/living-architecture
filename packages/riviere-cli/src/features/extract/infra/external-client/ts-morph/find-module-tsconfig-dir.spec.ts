...
describe('resolveModuleTsConfigDir', () => {
  const dirs: string[] = []
  ...
  it('returns module directory when module has its own tsconfig', () => {
    ...
    const result = resolveModuleTsConfigDir(testDir, 'shipping-domain')
  ...
  it('returns config directory when module has no tsconfig', () => {
    ...
    const result = resolveModuleTsConfigDir(testDir, 'orders-domain')
