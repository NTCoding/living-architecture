...
import type { addComponentToBuilder } from './add-component'

type AddComponentValidationError = {
...
type DomainInput = Parameters<typeof addComponentToBuilder>[1]
type CommonInput = Exclude<DomainInput, { type: 'API' }>['input']
