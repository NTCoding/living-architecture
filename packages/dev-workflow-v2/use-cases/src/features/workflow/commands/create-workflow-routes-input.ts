...
import type { ReviewerStatus } from '@living-architecture/dev-workflow-v2-domain-model/domain/reviews/statuses'
...
export interface CreateWorkflowRoutesInput {
  ...
  readonly recordIssue: (workflow: Workflow, issueNumber: number) => WorkflowOperationResult
  readonly recordBranch: (workflow: Workflow, branch: string) => WorkflowOperationResult
