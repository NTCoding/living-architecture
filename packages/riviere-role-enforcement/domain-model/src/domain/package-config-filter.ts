 ...
 * @riviere-role-justification Filtering one package's view of a configuration and selecting the files it lints both compare package patterns against the configuration's own assigned packages; no aggregate or value object owns that comparison because it reads the whole configuration rather than one of its attributes.
 */
export class PackageConfigFilter {
  forPackage(
