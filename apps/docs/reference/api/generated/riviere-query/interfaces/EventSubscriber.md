...
Defined in: [packages/riviere-query/src/event-types.ts:62](https://github.com/NTCoding/living-architecture/blob/main/packages/riviere-query/src/event-types.ts#L62)
...
Defined in: [packages/riviere-query/src/event-types.ts:64](https://github.com/NTCoding/living-architecture/blob/main/packages/riviere-query/src/event-types.ts#L64)
