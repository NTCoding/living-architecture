...
# Class: InvalidRiviereGraphError

Defined in: packages/riviere-query/src/domain/errors.ts:15
...
> **new InvalidRiviereGraphError**(`issues`): `InvalidRiviereGraphError`

Defined in: packages/riviere-query/src/domain/errors.ts:18
...
Defined in: packages/riviere-query/src/domain/errors.ts:16
