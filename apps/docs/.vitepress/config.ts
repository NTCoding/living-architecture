...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Riviere - Living Architecture' }],
    ...
    ['meta', { name: 'twitter:title', content: 'Riviere - Living Architecture' }],
      ...
      '/reference/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'ID Generation', link: '/reference/api/id-generation' },
            { text: 'Validation Rules', link: '/reference/api/validation-rules' },
            { text: 'Error Messages', link: '/reference/api/error-messages' },
          ]
        }
      ]
    },
