...
interface EventAccordionProps {
  ...
  readonly renderCodeLink?: (sourceLocation: EventSourceLocation) => React.ReactNode
}

interface EventSourceLocation {
    ...
    <div className="rounded-lg border border-[var(--border-color)]">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          {event.sourceLocation?.lineNumber !== undefined && renderCodeLink !== undefined && (
            <>{renderCodeLink({
