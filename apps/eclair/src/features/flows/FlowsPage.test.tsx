...
function createTestGraph(): RiviereGraph {
  return {
    ...
    components: [
      ...
      parseNode({ sourceLocation: testSourceLocation, id: 'api-1', type: 'API', name: 'GET /health', domain: 'app', module: 'api', httpMethod: 'GET', path: '/health' }),
...
describe('FlowsPage', () => {
  ...
  describe('flow cards', () => {
    it('expands flow card when clicked', async () => {
      ...
      const firstHeader = flowCardHeaders[0]
      if (firstHeader === undefined) {
        throw new Error('No flow card headers found')
      }
