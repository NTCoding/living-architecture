...
describe('NodeTypeFilters', () => {
  ...
  it('renders with node type filters heading', () => {
    render(
      <NodeTypeFilters
  ...
  it('displays all node types with counts', () => {
    render(
      <NodeTypeFilters
        nodeTypes={mockNodeTypes}
        visibleTypes={new Set(['API', 'UseCase', 'DomainOp'])}
  ...
  it('calls onShowAll when Show All clicked', async () => {
    const user = userEvent.setup()
  ...
  it('calls onHideAll when Hide All clicked', async () => {
    const user = userEvent.setup()
  ...
  it('disables Show All when all types visible', () => {
    render(
      <NodeTypeFilters
        nodeTypes={mockNodeTypes}
        visibleTypes={new Set(['API', 'UseCase', 'DomainOp'])}
  ...
  it('disables Hide All when no types visible', () => {
    render(
      <NodeTypeFilters
        nodeTypes={mockNodeTypes}
  ...
  it('toggles filter list visibility when header clicked', async () => {
    const user = userEvent.setup()
