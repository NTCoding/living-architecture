...
describe('calculateNodeDepths', () => {
  it('returns depth 0 for nodes with no incoming edges', () => {
    const nodeIds = ['A', 'B']
  ...
  it('returns depth 1 for nodes one step from entry point', () => {
    const nodeIds = ['A', 'B']
    const edges: TestEdge[] = [
      {
        source: 'A',
  ...
  it('uses max depth when node has multiple incoming paths', () => {
    const nodeIds = ['A', 'B', 'C', 'D']
    const edges: TestEdge[] = [
      {
        source: 'A',
  ...
  it('handles multiple entry points (no incoming edges)', () => {
    const nodeIds = ['A', 'B', 'C']
    const edges: TestEdge[] = [
      {
        source: 'A',
  ...
  it('handles diamond pattern with correct max depth', () => {
