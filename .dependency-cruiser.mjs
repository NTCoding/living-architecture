export default {
  forbidden: [
    ...
    },
    {
      ...
      severity: "error",
      comment: "Entrypoint must never import from its feature domain/",
      from: { path: "features/[^/]+/entrypoint/.+" },
      to: { path: "features/[^/]+/domain/.+" }
    },
    {
      ...
      to: {
        ...
        pathNot: "(features/$1/(entrypoint|commands|queries|infra)/|entrypoint/_platform/|platform/(domain|infra)/)"
      }
    },
    {
